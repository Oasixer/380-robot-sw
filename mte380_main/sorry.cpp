...
void Sorry::run(){
  ...
  // FOURTH LINE -----------
  // 5 PIT west
  drive(3,0,MOUNT_WALL_POWER,  5200, 0.4, GUIDED , -1, -167.2, false);
  ...
  drive(4,2,SLOW_POWER,    2000, 1.55, GUIDED,   1.72); // undershot by 1 ish inch on 1.50
  turnInPlace(4);
  ...
  drive(5,2,MEDIUM_POWER,    2000, 1.47, GUIDED,   1.75);
  turnInPlace(5);

  // 4 sand south
  // drive(6,0,FAST_POWER,    300, 1.47, GUIDED        ); // if this turns SUPER early go back to 800
  // drive(6,1,SLOW_POWER,  700, 1.47, GUIDED        );
  drive(6,0,FAST_POWER,  1000, 1.47, GUIDED);
  // drive(6,1,STOPPED_POWER,    400, 1.47, UNGUIDED        );
  drive(6,2,MEDIUM_POWER,    2000, 1.47, GUIDED,   1.85); // JUST 1.3
  turnInPlace(6);

  // 3 sand west
  /* drive(7,0,MEDIUM_POWER,   600, 1.47, GUIDED        ); */
  drive(7,0,SLOW_POWER,   1200, 1.52, GUIDED        );
  drive(7,0,STOPPED_POWER,    150, 1.52, UNGUIDED        );
  drive(7,2,SLOW_POWER,    2000, 1.52, GUIDED,   2.63); // overshoot 1 inch ish on 2.6
  turnInPlace(7);
  drive(7,3,STOPPED_POWER, 80, 1.5, UNGUIDED);

  // 3 sand north
  /* drive(8,0,MEDIUM_POWER,    1200, 2.47, GUIDED        ); */
  // drive(8,0,SLOW_POWER,    1170, 2.47, GUIDED        );
  drive(8,0,FAST_POWER,    720, 2.52, GUIDED        );
  drive(8,1,SLOW_POWER,    2000, 2.52, GUIDED,   2.43);
  turnInPlace(8);
  drive(8,2, STOPPED_POWER, 80, 2.55, UNGUIDED);
  // 2 wood east
  ...
  drive(10,1,SLOW_POWER,    2000, 2.47, GUIDED,   2.48); // overshoot 0.1 on 2.6
